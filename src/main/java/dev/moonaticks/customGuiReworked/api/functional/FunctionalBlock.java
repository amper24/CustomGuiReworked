...
public final class FunctionalBlock {
    ...
    public static final class Builder {
        ...
        public FunctionalBlockHandler build() {
            ...
            return new HandlerImpl(guiName, canOpen, onOpen, onClick, onClose, onTick, recipe, fuelConsumption);
        }
    ...
    private static final class HandlerImpl implements FunctionalBlockHandler {
        ...
        HandlerImpl(String guiName, BiPredicate<Player, Location> canOpen,
                    Builder.OnOpen onOpen, Builder.OnClick onClick, Builder.OnClose onClose,
                    Builder.OnTick onTick, CraftingRecipe recipe, Map<Integer, Integer> fuelConsumption) {
            this.guiName = guiName;
